		...
		<div class="container py-xl-4 py-lg-2">
										...
										<div class="quantity">
											<form class="form">
												<div class="form-group">
													...
													<input type="number" name="qty" class="form-control qty" min =1 value="{{ $value->qty }}" data-id ="{{$value-> rowId}}">
												</div>
			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					<a href="{{ route('cart.checkout') }}" class="submit check_out btn">Giao hàng đến địa chỉ này</a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Bạn có muốn xóa sản phẩm tromg giỏ hàng không? </h5>
