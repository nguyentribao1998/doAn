...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="keywords" content="Electro Store Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEriassets/client/csson, Motorola web design"
    />
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{route('login')}}" method="post">
						...
						<div class="right-w3l">
							<a href="login/facebook" class="btn btn-primary" style="width: 448px">Đăng nhập bằng facebook</a>
						</div>
						<div class="sub-w3l">
